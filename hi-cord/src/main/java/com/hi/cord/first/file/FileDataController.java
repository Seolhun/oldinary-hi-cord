package com.hi.cord.first.file;
...
import com.hi.cord.first.file.service.FileDataService;
...
public class FileDataController {
	...
	static final Logger log = LoggerFactory.getLogger(FileDataController.class);
